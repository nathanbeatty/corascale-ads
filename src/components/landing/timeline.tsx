...
import { CalendarDays, Play, ArrowRightCircle } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center justify-center  ">
            ...
            <div className="p-8 mx-auto col-span-2 max-w-lg">
              <div className="p-0 mb-4">
                <h3 className="text-2xl md:text-4xl tracking-tight font-medium">Implementation Timeline</h3>
                {/* <p className="text-sm text-muted-foreground mt-1">Three simple weeks to launch and start booking meetings.</p> */}
              </div>
              ...
              <div className="mt-6 space-y-6">
                {steps.map(({ title, desc, icon: Icon }, idx) => (
                  <div key={idx} className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-slate-900 dark:text-slate-100">{title}</h4>
